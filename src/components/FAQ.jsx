...
function FAQ() {
    const data = [
        { question: 'How do I join Zipcar?', answer: "Apply online with a valid driver's license and download our personal car rental app. Most people are approved instantly and rent a car within minutes. Learn more." },
        { question: 'How much does Zipcar cost?', answer: "Zipcar memberships start at $9 a month or $90 a year. Reserve cars by the hour or by the day. Gas, insurance options,* and 180 miles per day are all included in membership. Other fees, such as a young driver fee, may apply. Price it out." },
        { question: 'How soon can I drive with Zipcar?', answer: "First, sign up for membership. Most members are approved instantly and can book their first daily or hourly car rental within minutes but in some cases, it may take a little longer to check your driving record. As soon as you're approved, you can book a Zipcar near you and use our car rental app to unlock and lock during your trip. We'll also mail you a Zipcard—an access card to any Zipcar vehicle you reserve. It arrives in 5-7 business days. Until it does, it's better to book cars and trips in places where your phone has service." },
        { question: 'Are there Zipcars near me?', answer: "Zipcars live in hundreds of cities and towns globally. Type your address in the search bar below to find Zipcars near you. When booking a reservation, you can choose a car type to fit your needs or your mood—from compact sedans to larger cars such as cargo vans and SUVs, and even luxury car rentals, we’ve got you covered." },
